        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 h-16 flex items-center justify-between gap-2 sm:gap-4">
          ...
          <nav className="hidden md:flex items-center gap-6 text-xs font-extrabold uppercase tracking-wider text-gray-600 h-full">
            ...
            >
              ...
              >
                ...
                <ChevronDown className={`h-3.5 w-3.5 transition-transform duration-200 ${isCollectionsHovered ? "rotate-180" : ""}`} strokeWidth={2} />
              </Link>
          ...
          <div ref={searchRef} className="hidden md:block relative flex-1 max-w-xs sm:max-w-md mx-2">
            <div className="relative">
              ...
              />
              <Search className="absolute left-3 top-2.5 h-4 w-4 text-gray-400" strokeWidth={2} />
              {searchQuery && (
                <button
          ...
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
                    ...
                    {!user ? (
                      ...
                      <>
                        <Link
                          ...
                          className="block px-4 py-2.5 text-xs font-bold text-gray-800 hover:bg-orange-50 hover:text-orange-600 transition-colors"
                        >
                          <span className="flex items-center gap-2"><CircleUserRound className="h-4 w-4" strokeWidth={2} /> My Account & Profile</span>
                        </Link>
                        {isAdmin && (
                          <Link
                            href="/admin"
                        ...
                        >
                          <span className="flex items-center gap-2"><LogOut className="h-4 w-4" strokeWidth={2} /> Sign Out</span>
                        </button>
                      </>
                    )}
                  </div>
            ...
            <Link
              ...
              title="Wishlist"
            >
              <Heart className={`h-5 w-5 transition-colors ${contextWishlistCount > 0 ? "fill-red-500 text-red-500" : "text-gray-700"}`} fill={contextWishlistCount > 0 ? "currentColor" : "none"} strokeWidth={2} />
        ...
        {isMobileSearchExpanded && (
          <div ref={mobileSearchRef} className="md:hidden px-4 pb-3 pt-1 border-t border-gray-100 bg-white shadow-md">
            <div className="relative flex items-center">
              ...
              />
              <Search className="absolute left-3 h-4 w-4 text-gray-400" strokeWidth={2} />
              {searchQuery && (
                <button
                  onClick={() => setSearchQuery("")}
